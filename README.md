# Viera's Restaurant
Viera's Restaurant is an ecommerce website built using React, Redux integrated with Node.js and Express backend.
...
## Testing
1. In project directory run in terminal: `npm test`#   v i e r a s _ r e s t a u r a n t 
